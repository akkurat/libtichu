...
internal class CardUtilsKtTest {
    ...
    @Test
    fun patternRelMajon() {
        val p = pattern(listOf(MAH, S2, S3, D4, P5))
        assertNotNull(p)
    ...
    fun patternFhNot() {
        assertThrows<IllegalArgumentException> {
            pattern(listOf(MAH, J2, D2, J11, D11, PHX.asPlayCard(11)))
        }
    }
    ...
    @Test
    fun pairInvalid() {
        val inValid = listOf(listOf(S13, DRG), listOf(S4, D7), listOf(S4, MAH))
    ...
    @Test
    fun allPatterns() {
        val deck = listOf<HandCard>(MAH, J2, D3, J3, P3, S3, D4, P5, J7, D8, S8, D11, J12, P14)
    }
